    <div class=" shadow-md px-4 py-3 rounded-lg w-full">
        <div class="flex items-center">
            <img class="h-12 w-12 rounded-full" src="https://lh3.googleusercontent.com/proxy/plfa3Sn3t86C90C9AUtiwC7_AkqdCk1JpxDI0WeAKK9G1ffDRguMFAJ4gd76q0jfuT4kj47xm4jlR2UXOJlNnhzczCklWknEBPdi8IOgaIyFG5ZZvj07"/>
            <div class="ml-2">
                <div class="text-sm ">
                ...
                <div class="text-gray-500 text-xs flex">
                    ...
                    <span class="inline-block"> 3d </span>
                </div>
            </div>
        </div>
        <p class="text-gray-800 text-sm mt-2 leading-normal md:leading-relaxed">Aqui ira el comentario que hayan escrito los usuarios, como se puede ver cuando se escribe un texto largo va pa bajo sabe lo k t digo?</p>
