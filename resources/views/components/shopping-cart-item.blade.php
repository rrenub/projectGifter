<div class="px-6 px-8 bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100 flex items-center justify-between w-100">
        <div class="p-2 w-12 h-auto"><img src="{{ $img }}" alt="img product"></div>
        <div class="flex-auto text-sm w-32">
            <div class="font-bold">{{ $name }}</div>
            <div class="text-gray-400">Qt: {{ $cantidad }}</div>
        </div>
