        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button class="block w-full max-w-xs mx-auto bg-yellow-500 duration-200 hover:bg-yellow-600 focus:bg-yellow-600 text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                        </div>
                    </div>
                </div>
            </div>
